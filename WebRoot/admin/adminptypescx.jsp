...
<body>
  <form  action="adminptypescx.jsp"  name="f1" method="post"  >
...
String url = "adminptypescx.jsp?1=1&uname="+puname+"&ptname="+pptname+""; 
...
<a onclick="return confirm('确定要删除这条记录吗?')"  href="adminptypescx.jsp?scid=<%=map.get("id")%>">删除</a>
</td>
</tr>
<%}%>
