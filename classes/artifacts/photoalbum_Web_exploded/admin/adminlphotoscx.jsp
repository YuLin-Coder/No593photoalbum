...
<body>
  <form  action="adminlphotoscx.jsp"  name="f1" method="post"  >
...
String url = "adminlphotoscx.jsp?1=1&uname="+puname+"&phoname="+pphoname+"&savetime="+psavetime+""; 
...
<a onclick="return confirm('确定要删除这条记录吗?')"  href="adminlphotoscx.jsp?scid=<%=map.get("id")%>">删除</a>
</td>
</tr>
<%}%>
