...
<%
 ...
 %>
  <form action="/photoalbum/admin/gggl.jsp?f=f" name="f1"  method="post">
    <%

 String hql = "select * from mixinfo where infotype='公告' ";
        String url = "/photoalbum/admin/gggl.jsp?1=1";
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  <td width="150" align="center" class="main_matter_td" height="30">关键字</td>
                  <td width="" align="left" class="main_matter_td">
                  <input name="key" type="text"  class="textBox" size="45" /> 

&nbsp;&nbsp;

<input type="button" onclick="f1.submit();" name="Submit" value="查询公告" /> 
			        
			       
			        
			       &nbsp;&nbsp; 
			        
			       <input type="button" onclick="add();" name="Submit2" value="添加公告" />
         ...
         %>
          ...
          <%
            ...
            <script language=javascript>
			       function add()
			       {
			       pop("/photoalbum/admin/addgggl.jsp","添加公告",700,'100%');
			       }
			       
			        function update(no)
			       {
			       pop("/photoalbum/admin/updategggl.jsp?id="+no,"修改公告",700,'100%');
			       }
			       </script>
