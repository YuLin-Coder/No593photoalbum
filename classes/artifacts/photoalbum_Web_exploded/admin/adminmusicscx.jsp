...
<body>
  <form  action="adminmusicscx.jsp"  name="f1" method="post"  >
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td colspan=5   align="left" class="main_matter_td" height='30'>&nbsp;&nbsp;&nbsp;
<% 
...
<td align="center" class="main_title_td_center2">歌名</td>
<td align="center" class="main_title_td_center2">音乐文件</td>
...
String url = "adminmusicscx.jsp?1=1&uname="+puname+"&mname="+pmname+""; 
...
<a onclick="return confirm('确定要删除这条记录吗?')"  href="adminmusicscx.jsp?scid=<%=map.get("id")%>">删除</a>
</td>
</tr>
<%}%>
          ...
          <tr 
              onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#f0f7ff'" 
              onmouseout="this.style.backgroundColor=currentcolor">
            <td colspan=5 height="15"  align="center" valign="middle" class="main_matter_td">${page.info}</td>
          </tr>
      </table></td>
  </tr>
</table>
